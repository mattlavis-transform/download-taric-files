...
class GoodsNomenclature(object):
    ...
    def __init__(self):
        ...
        self.goods_nomenclature_description_string = ""
    ...
    def parse_node(self, app, update_type, message, transaction_id, message_id, record_code, sub_record_code):
        ...
        self.productline_suffix = g.app.get_value(message, ".//oub:producline.suffix", True)
        ...
        self.operation = g.app.get_loading_message(update_type, "goods nomenclature", self.goods_nomenclature_sid)

    def combine(self):
        for item in self.self.goods_nomenclature_descriptions:
            self.goods_nomenclature_description_string += item.description
            print("In loop")
        print(self.goods_nomenclature_description_string)