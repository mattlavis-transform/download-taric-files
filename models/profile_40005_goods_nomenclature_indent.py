...
class GoodsNomenclatureIndent(object):
    def parse_node(self, app, update_type, message, transaction_id, message_id, record_code, sub_record_code):
        g.app.message_count += 1
        self.matched = False
        self.operation_date = g.app.get_timestamp()
        self.goods_nomenclature_indent_sid = g.app.get_number_value(message, ".//oub:goods.nomenclature.indent.sid", True)
        ...
        self.number_indents = g.app.get_value(message, ".//oub:number.indents", True)
        ...
        operation = g.app.get_loading_message(update_type, "goods nomenclature indent", self.goods_nomenclature_indent_sid)
