...
class GoodsNomenclatureIndent(object):
    def parse_node(self, app, update_type, message, transaction_id, message_id, record_code, sub_record_code):
        ...
        goods_nomenclature_indent_sid = g.app.get_number_value(message, ".//oub:goods.nomenclature.indent.sid", True)
        ...
        number_indents = g.app.get_value(message, ".//oub:number.indents", True)
